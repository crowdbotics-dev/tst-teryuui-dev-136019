"""
Django settings for tst_teryuui_dev_136019 project.
...
ROOT_URLCONF = 'tst_teryuui_dev_136019.urls'
...
WSGI_APPLICATION = 'tst_teryuui_dev_136019.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_teryuui_dev_136019 API",
    "DESCRIPTION": "API documentation for tst_teryuui_dev_136019 App",
    "VERSION": "v1",
}
